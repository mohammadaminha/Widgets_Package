...
public class JalaliCalendar {
     ...
     */
    private GregorianCalendar toGregorian() {
     ...
     */
    private void fromGregorian(GregorianCalendar gc) {
     ...
     */
    private JalaliCalendar getDateByDiff(int diff) {
    ...
    private int toJulianDay() {
        ...
        return julianToJulianDayNumber(julianFirstFarvardin) + (jalaliMonth - 1) * 31 - jalaliMonth / 7 * (jalaliMonth - 7)
                + jalaliDay - 1;
    }
