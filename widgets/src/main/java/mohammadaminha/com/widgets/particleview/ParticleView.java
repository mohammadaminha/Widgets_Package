package mohammadaminha.com.widgets.particleview;
...
public class ParticleView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        bold = Typeface.create(Util.getTypeFace(), Typeface.BOLD);
        ...
        mHostTextPaint.setTypeface(bold);
        mHostBgPaint.setTypeface(bold);
        mParticleTextPaint.setTypeface(bold);
