...
import mohammadaminha.com.widgets.Date_Picker.multidate.MonthView.OnDayClickListener;
...
public abstract class MonthAdapter extends BaseAdapter implements OnDayClickListener {
    ...
    private ArrayList<PersianCalendar> mSelectedDays;
    ...
    protected abstract MonthView createMonthView(Context context);
