...
package mohammadaminha.com.widgets.Date_Picker.multidate;
...
import mohammadaminha.com.widgets.Date_Picker.TypefaceHelper;
import mohammadaminha.com.widgets.Date_Picker.Utils;
import mohammadaminha.com.widgets.Date_Picker.multidate.MonthAdapter.CalendarDay;
import mohammadaminha.com.widgets.Date_Picker.utils.LanguageUtils;
import mohammadaminha.com.widgets.Date_Picker.utils.PersianCalendar;
import mohammadaminha.com.widgets.R;
...
public abstract class MonthView extends View {
    ...
    private static final int DEFAULT_WEEK_START = Calendar.SATURDAY;
    ...
    private PersianCalendar mDayLabelCalendar;
    ...
    final int mSelectedDayTextColor;
    private int mMonthDayTextColor;
    final int mTodayNumberColor;
    final int mHighlightedDayTextColor;
    final int mDisabledDayTextColor;
    ...
    MonthView(Context context, AttributeSet attr, DatePickerController controller) {
        super(context, attr);
    ...
    private void initView() {
        ...
        mMonthTitlePaint.setTypeface(Util.getTypeFace());
     ...
     */
    protected abstract void drawMonthDay(Canvas canvas, int year, int month, int day,
     ...
     */
    private int getInternalDayFromLocation(float x, float y) {
    ...
    protected class MonthViewTouchHelper extends ExploreByTouchHelper {
        ...
        private PersianCalendar mTempCalendar = new PersianCalendar();
