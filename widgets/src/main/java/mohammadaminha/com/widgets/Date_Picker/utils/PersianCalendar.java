package mohammadaminha.com.widgets.Date_Picker.utils;
...
public class PersianCalendar extends GregorianCalendar {
	...
	public String getPersianShortDateTime() {
		return
				//formatToMilitary(this.persianYear) + delimiter +
				//formatToMilitary(getPersianMonth() + 1) + delimiter +
				//formatToMilitary(this.persianDay) + " " +
				(this.persianYear) + delimiter +
						(getPersianMonth() + 1) + delimiter +
						(this.persianDay) + " " +
						formatToMilitary(this.get(HOUR_OF_DAY))
						+ ":" +
	...
	public String getPersianHour() {
		return
				formatToMilitary(get(HOUR_OF_DAY))
						+ ":" +
						formatToMilitary(get(MINUTE));
	}

	public String formatToMilitary(int i) {
