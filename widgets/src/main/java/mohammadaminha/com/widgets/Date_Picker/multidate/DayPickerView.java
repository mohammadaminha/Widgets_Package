...
import mohammadaminha.com.widgets.Date_Picker.multidate.MultiDatePickerDialog.OnDateChangedListener;
...
public abstract class DayPickerView extends ListView implements OnScrollListener,
    ...
    // highlighted time
    private MonthAdapter.CalendarDay mSelectedDay = new MonthAdapter.CalendarDay();
    private MonthAdapter mAdapter;

    private MonthAdapter.CalendarDay mTempDay = new MonthAdapter.CalendarDay();
...
//        }
     ...
     */
    private void goTo(MonthAdapter.CalendarDay day, boolean animate, boolean setSelected, boolean forceScroll) {
