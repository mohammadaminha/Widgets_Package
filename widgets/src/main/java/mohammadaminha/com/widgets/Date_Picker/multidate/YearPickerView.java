...
import mohammadaminha.com.widgets.Date_Picker.date.TextViewWithCircularIndicator;
...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
    ...
    private static int getYearFromTextView(TextViewWithCircularIndicator view) {
    ...
    private void postSetSelectionCentered(final int position) {
