...
import mohammadaminha.com.widgets.Date_Picker.date.AccessibleDateAnimator;
...
public class MultiDatePickerDialog extends DialogFragment implements
    ...
    private ArrayList<PersianCalendar> mSelectedDaysCalendars = new ArrayList<>();
    ...
    private void initialize(OnDateSetListener callBack, @Nullable ArrayList<PersianCalendar> selectedDays) {
        mCallBack = callBack;
