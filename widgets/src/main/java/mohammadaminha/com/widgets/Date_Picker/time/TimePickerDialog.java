...
package mohammadaminha.com.widgets.Date_Picker.time;
...
import mohammadaminha.com.widgets.Date_Picker.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    private void initialize(OnTimeSetListener callback,
                            int hourOfDay, int minute, boolean is24HourMode) {
        mCallback = callback;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int accent = res.getColor(R.color.mdtp_white);
        int circleBackground = res.getColor(R.color.mdtp_circle_background);
        int line = res.getColor(R.color.mdtp_white);
