...
public class JalaliCalendar1 extends Calendar {
    private static final int[] gregorianDaysInMonth = {31, 28, 31, 30, 31,
            30, 31, 31, 30, 31, 30, 31};
    private static final int[] jalaliDaysInMonth = {31, 31, 31, 31, 31, 31,
            30, 30, 30, 30, 30, 29};

    private static int FARVARDIN = 0;
    ...
    public JalaliCalendar1() {
        this(TimeZone.getDefault(), Locale.getDefault());
    }

    public JalaliCalendar1(TimeZone zone) {
        this(zone, Locale.getDefault());
    }

    public JalaliCalendar1(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale);
    }

    private JalaliCalendar1(TimeZone zone, Locale aLocale) {
    ...
    public JalaliCalendar1(int year, int month, int dayOfMonth) {
        this(year, month, dayOfMonth, 0, 0, 0, 0);
    }

    public JalaliCalendar1(int year, int month, int dayOfMonth, int hourOfDay,
                           int minute) {
    ...
    private JalaliCalendar1(int year, int month, int dayOfMonth,
    ...
    private static int weekOfYear(int dayOfYear, int year) {
        switch (dayOfWeek(JalaliCalendar1.jalaliToGregorian(new YearMonthDate(year, 0, 1)))) {
            case 2:
                dayOfYear++;
                break;
            case 3:
